/**
 * Changelog Archive Data - File 1
 * Contains older changelog entries (Versions 1.0.3, 1.0.2, 1.0.1, 1.0.0)
 */
(function() {
    'use strict';
    
    const filename = 'changelog-archive-1.js';
    const htmlContent = `<!-- Changelog Archive File 1 -->
<!-- Contains older changelog entries (Versions 1.0.3, 1.0.2, 1.0.1, 1.0.0) -->
    ...
    <div class="card">
        <div class="card-body">
            ...
            <ul class="mb-0">
                ...
                <li>Updated all HTML pages to load CSS in correct cascade order (base → page-base → page-specific → variant-specific).</li>
...
<article class="changelog-entry mb-4">
    ...
    // Store in global object for core to retrieve
    if (!window.ChangelogArchiveData) {
        window.ChangelogArchiveData = {};
    }
    window.ChangelogArchiveData[filename] = htmlContent;
    
    console.log(`[Changelog Archive] Loaded ${filename}`);
})();
